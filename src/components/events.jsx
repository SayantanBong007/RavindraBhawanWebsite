...
export default function Events() {
  ...
  return (
    <section className="galleryMain" id="Events">
      <h1>Events</h1>

      <div className="galleryImages">
        <button className="scrollButtons leftBtn" onClick={scrollLeft}>
        ...
        <button className="scrollButtons rightBtn" onClick={scrollRight}>
